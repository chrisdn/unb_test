...
class UnbluController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Task {
            do {
                var config = UnbluClientConfiguration(unbluBaseUrl: "<end-point>", apiKey: "", preferencesStorage: UserDefaultsPreferencesStorage(), fileDownloadHandler: UnbluDefaultFileDownloadHandler(), externalLinkHandler: UnbluDefaultExternalLinkHandler())
